...
//	const CGFloat height = sizeThatFits.height;
    ...
    CGFloat height = sizeThatFits.height;
    CGFloat x, y;
	...
	if(self.alignment == kButtonAlignmentImageTop || self.alignment == kButtonAlignmentLabelTop){
        ...
        CGRect titleFrame=contentRect;
        titleFrame.size.width-=(self.currentImage.size.width + self.gap);
        
		CGFloat totalWidth = [self _expectedTotalWidth:titleFrame];
        width=totalWidth-self.gap-self.currentImage.size.width;
